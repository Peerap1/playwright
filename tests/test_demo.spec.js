...
test('Login Demo 1', async ({ page }) => {
    ...
    await page.locator('xpath=//*[text()="Lending"]').click()
    ...
    await expect(page.locator('text=ramdom')).not.toBeVisible()
    await expect(page.locator('xpath=//*[text()="Lending"]')).toBeVisible()
